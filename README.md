...
>
> As of [2026-04-23](https://github.com/orgs/community/discussions/38659#discussioncomment-16690119), GitHub now natively supports this via the job context (e.g. `job.workflow_ref`), making this action redundant. [Learn more](https://docs.github.com/en/actions/reference/workflows-and-actions/contexts#job-context).
>
